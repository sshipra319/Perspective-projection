...
class cl_toolbar :
  ...
  def toolbar_perspective_callback( self ) :
      ...
      if viewDistance is None:
          self.master.Perspective.set(0)
          self.master.viewDistance = None
      else:
  ...
  def toolbar_draw_callback( self ) :
      if self.model:
          ...
          self.master.ob_world.create_graphic_objects( self.master.ob_canvas_frame.canvas, self.model, self.master.Clipping.get(), self.master.Perspective.get() )
